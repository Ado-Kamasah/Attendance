...
import { getFaculties, createFaculty, deleteFaculty, updateFaculty } from '../controllers/facultyController.js';
...
router.put('/:id', authenticateToken, requireRole(['ADMIN']), updateFaculty);
