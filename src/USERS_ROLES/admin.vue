  ...
  <div>
    ...
    >
      ...
      <div class="h-18 px-4 flex items-center justify-between border-b border-[#162746] dark:border-[#0e1a30] shrink-0">
        ...
        <!-- Close Mobile Button (mobile only) -->
        <button 
          @click="$emit('close-mobile')" 
      ...
      <div class="p-3 border-t border-[#162746] dark:border-[#0e1a30] shrink-0 bg-[#030b19]">
        ...
        >
          ...
          <div class="relative shrink-0">
            <img 
              :src="`https://ui-avatars.com/api/?name=${encodeURIComponent(userName)}&background=bc9333&color=031c45&bold=true`" 
              alt="User Avatar"
...
const navGroups = [
  {
    ...
    items: [
      ...
      { name: 'Evaluations', path: '/evaluation-admin', icon: CheckSquare },
      { name: 'Class Representatives', path: '/classrep-management', icon: UserCheck },
      { name: 'Suggestion Box', path: '/suggestions-admin', icon: MessageSquare }
    ]
  }
];
</script>
